...
| RSS feed | `/rss.xml` | Every published post, newest first; not a page |
| Sitemap | `/sitemap-index.xml` | Generated by `@astrojs/sitemap` from every prerendered route; not a page |
